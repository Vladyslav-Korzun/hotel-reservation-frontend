...
@Component({
  ...
  templateUrl: './home-search-form.html',
  styleUrl: './home-search-form.scss',
})
export class HomeSearchForm {
  ...
  protected readonly form = new FormGroup(
    {
      ...
      checkIn: new FormControl(todayDisplayDate(), { nonNullable: true, validators: [Validators.required, displayDateValidator] }),
